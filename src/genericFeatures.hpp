 ...
 * \details This class is used to define several generic functions useful to the application or any of projet classes without instantiate the class. Basically, all public functions are declared as static to avoid the class instanciation
